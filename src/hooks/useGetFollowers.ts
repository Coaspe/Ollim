...
import { getFollowersInfinite, getFollowingsInfinite } from "../services/firebase";
import { getFirestoreUser } from "../type";

const useGetFollowers = (setLoading: React.Dispatch<React.SetStateAction<boolean>>, profileOwnerInfo:getFirestoreUser, followersModal:boolean, followingsModal:boolean) => {
...
return {followersKey, followingsKey, followers, followings, handleMoreFollowers, handleMoreFollowings}
}
